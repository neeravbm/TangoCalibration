...
public class TangoJniNative {
    static {
        ...
        System.loadLibrary("tango-calibration-lib");
    }
     ...
     */
    public static native void onGlSurfaceDrawFrame(boolean undistort);

    /**
     * Delegate {@code GLSurfaceView.onGlSurfaceDrawFrame} to the native code code.
     */
    public static native void onGlSurfaceDrawFrame2();
    ...
    public static native void clickPhoto();
}
