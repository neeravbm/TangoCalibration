...
#ifndef TANGOCALIBRATION_TANGOCALIBRATIONAPP_H_
#define TANGOCALIBRATION_TANGOCALIBRATIONAPP_H_
...
// HelloVideoApp handles the application lifecycle and resources.
    ...
    public:
        ...
        // Main render loop.
        void OnDrawFrame(bool undistort = 0);
    ...
    private:
        ...
        void RenderYuv(bool undistort = 0);
        void RenderTextureId();
        void DeleteDrawables();

        // Stores whether calibration pattern is found in the latest image captured by the camera.
        bool patternFound;

        // Latest color image captured by the camera.
        //cv::Mat rgb_img;

    };
}  // namespace tango_calibration

#endif  // TANGOCALIBRATION_TANGOCALIBRATIONAPP_H_
